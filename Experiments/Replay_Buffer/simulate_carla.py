...
from Experiments.Replay_Buffer.config import SimpleNN
...
def simulate_carla(trial_num,log_dir):
    ...
    optim = torch.optim.Adam(model_copy.parameters(), lr=online_lr, weight_decay=online_weight_decay)
    ...
    try:
        for i in range(1, Steps):
            ...
            prediction = model_copy(M_u_tensor)
            if (i > window_steps):
                ...
                if (i > window_steps + buffer_size):
                    ...
                    prediction = model_copy(input_data)
